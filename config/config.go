...
type Caterpillar struct {
	...
	Interval  string      `json:"interval,omitempty"`   //How often to spawn this caterpillar, in the duration.ParseDuration format. See https://golang.org/pkg/time/#ParseDuration
}
